...
left_right = input("You enter a cave and now you are at a crossroads. Where do you want to go? Type 'left' or 'right'\n")
if left_right == 'left':
    print("You hear the voice of Count Mondego, who has followed you to a certain point and is also inside the cave.")
